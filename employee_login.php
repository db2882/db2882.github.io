...
<div class="splash-container">
    <div class="splash">
        ...
        <input id="Employee_id" name="employee_id" type="text" placeholder="Employee ID">
...
<?php
	...
	if($_GET["employee_id"] !== NULL && $_GET["employee_id"] != "" &&
   ...
   $con = NULL;
	...
	if ($num_results > 0){ 
		print("<script type=\"text/javascript\">window.location.href=\"employee_home.php?employee_id=$id\" ;</script>");
		exit();
	}else{ 
